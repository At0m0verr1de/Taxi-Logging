...
public class FoodCategory implements ActionListener, ItemListener {
    ConnectionClass obj;
    ...
    FoodCategory(ConnectionClass obj) {
        this.obj = obj;

        f = new JFrame("Edit Food Category");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == b1) {
            if (!t1.getText().equals("")) { // Aadhaar field cannot be empty if the driver is found
                ...
                String q = "insert into food_category values('" + t1.getText() + "');";
                int a;
                try {
            ...
            String query = "Delete from food_category WHERE category like '" + c1.getSelectedItem() + "';";
            int aa;
            try {
                ...
                if (aa > 0) {
                    ...
                    JOptionPane.showMessageDialog(null, "Category not found. Try Again.");
                }
            } catch (SQLException e1) {
                // TODO Auto-generated catch block
                e1.printStackTrace();
