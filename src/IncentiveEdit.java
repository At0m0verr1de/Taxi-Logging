...
public class IncentiveEdit implements ActionListener, ItemListener {
    ConnectionClass obj;
    ...
    IncentiveEdit(ConnectionClass obj) {
        this.obj = obj;

        f = new JFrame("Edit Incentive");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == b1) {
            if (!t1.getText().equals("")) { // Aadhaar field cannot be empty if the driver is found
                ...
                String q = "insert into incentive values(" + Integer.parseInt(t1.getText()) + ", '"
                        + c1.getSelectedItem() + "')";
                int a;
                try {
                    a = obj.stm.executeUpdate(q);
                    if (a == 1) {
                        JOptionPane.showMessageDialog(null, "Incentive Added!");
                        c2.addItem(t1.getText());
                    } else {
            ...
            String query = "Delete from incentive WHERE type like '" + c1.getSelectedItem() + "' and amount like "
                    + c2.getSelectedItem() + ";";
            int aa;
            try {
                ...
                if (aa > 0) {
                    JOptionPane.showMessageDialog(null, "Incentive removed successfully.");
